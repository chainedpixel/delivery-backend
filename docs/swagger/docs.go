    ...
    "definitions": {
        ...
        "entities.Availability": {
            ...
            "properties": {
                ...
                "driver": {
                    "description": "Inverse Relationships",
                    "allOf": [
                        {
        ...
        "entities.Company": {
            ...
            "properties": {
                "address": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/entities.CompanyAddress"
                        }
                    ]
                },
                "branches": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/entities.Branch"
                    }
                },
                "contactEmail": {
                    "type": "string"
        ...
        "entities.Driver": {
            ...
            "properties": {
                ...
                "driverZones": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/entities.DriverZone"
                    }
                },
                "isActive": {
                    "type": "boolean"
        ...
        "entities.Inventory": {
            ...
            "properties": {
                ...
                "warehouse": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/entities.Warehouse"
                        }
                    ]
                },
                "warehouseID": {
        ...
        "entities.Order": {
            ...
            "properties": {
                ...
                "deliveryAddress": {
                    "$ref": "#/definitions/entities.DeliveryAddress"
                },
                "detail": {
                    "description": "Relationships one to one",
                    "allOf": [
                        {
                            "$ref": "#/definitions/entities.Details"
                        }
                    ]
                },
                "driver": {
                ...
                "packageDetail": {
                    "$ref": "#/definitions/entities.PackageDetail"
                },
                "pickupAddress": {
                    "$ref": "#/definitions/entities.PickupAddress"
                },
                "qrcode": {
                    "$ref": "#/definitions/entities.QRCode"
                },
                "status": {
                    "type": "string"
                },
                "statusHistory": {
                    "description": "Relationships one to many",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/entities.StatusHistory"
                    }
                },
                "tracking": {
                    "$ref": "#/definitions/entities.Tracking"
                },
                "trackingNumber": {
                    "type": "string"
                },
                ...
                "warehouseTrackings": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/entities.PackageTracking"
                    }
                }
            }
        },
